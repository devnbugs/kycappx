...
Route::middleware('auth')->group(function () {
    Route::controller(SocialAuthController::class)->group(function () {
        Route::get('/profile/social-complete', 'completeProfile')->name('social.profile.complete');
        Route::post('/profile/social-complete', 'storeCompletedProfile')->name('social.profile.complete.store');
    });
    ...
    Route::middleware('social.profile.complete')->group(function () {
        ...
        Route::controller(VerificationController::class)->group(function () {
            ...
            Route::get('/verifications/{verificationRequest}', 'show')->name('verifications.show');
            Route::get('/verifications/{verificationRequest}/download', 'download')->name('verifications.download');
            Route::get('/verifications/{verificationRequest}/print', 'print')->name('verifications.print');
        });
        ...
        Route::prefix('admin')->name('admin.')->middleware('admin')->group(function () {
            Route::controller(AdminController::class)->group(function () {
                ...
                Route::get('/logs/verifications/{verificationRequest}', 'verificationLogShow')->name('logs.verifications.show');
