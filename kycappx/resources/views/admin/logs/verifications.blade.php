<x-layouts.dashboard-admin title="Verification Logs" header="Verification Processing Logs">
    <section class="surface-card p-6 sm:p-8">
        ...
        <h2 class="mt-3 text-2xl font-semibold text-slate-950">Provider outcomes, customer pricing, and queue status</h2>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody>
                    ...
                    @empty
                        <tr class="table-row">
                            <td colspan="7" class="px-6 py-10 text-center text-slate-500">No verification logs have been recorded yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
